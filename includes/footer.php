<footer>
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h5>About</h5>
                    <p>We are here to provide a customer fresh ,green, hygenic vegetable at doorstep in lesser time to avoid their inconvenience in daily routine</p>
                </div>
                <div class="col-md-3">
                    <h5>Links</h5>
                    <ul>
        ...
        <p class="copyright">&copy; 2023 Green Grocery | Groceries Organic Store. All rights reserved.</p>
    </footer>
